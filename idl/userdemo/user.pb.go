...
var file_user_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x2f, 0x75,
	0x73, 0x65, 0x72, 0x64, 0x65, 0x6d, 0x6f, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
func (c *userServiceClient) MGetUser(ctx context.Context, in *MGetUserRequest, opts ...grpc.CallOption) (*MGetUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/user.UserService/MGetUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserService_MGetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.UserService/MGetUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
